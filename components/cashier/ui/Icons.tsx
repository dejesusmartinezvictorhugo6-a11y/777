...
export const BanknotesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.75A.75.75 0 013 4.5h.75m0 0h.75A.75.75 0 015.25 6v.75m0 0v.75a.75.75 0 01-.75.75h-.75m0 0H3.75m0 0h-.75a.75.75 0 01-.75-.75V6.75m0 0v-.75A.75.75 0 013 5.25h.75M15 11.25a3 3 0 11-6 0 3 3 0 016 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12.75c0 .621-.504 1.125-1.125 1.125H9.874c-.621 0-1.125-.504-1.125-1.125V11.25c0-.621.504-1.125 1.125-1.125h4.25c.621 0 1.125.504 1.125 1.125V12.75z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 4.5v.75A.75.75 0 0118 6h-.75m0 0v-.75A.75.75 0 0118 4.5h.75m0 0h.75A.75.75 0 0120.25 6v.75m0 0v.75a.75.75 0 01-.75.75h-.75m0 0h-1.5m0 0h-.75a.75.75 0 01-.75-.75V6.75m0 0v-.75A.75.75 0 0118 5.25h.75M6.375 18.75a9.375 9.375 0 013.423-2.348" />
  </svg>
);
...
export const FacebookIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v7.029A10.001 10.001 0 0 0 22 12z" />
    </svg>
);

export const XIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231L18.244 2.25zM17.5 19.5h1.5l-6.52-8.775L6.5 4.5h-1.5l6.52 8.775L17.5 19.5z" />
    </svg>
);
