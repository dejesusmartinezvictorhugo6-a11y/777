...
export const GAMES: Game[] = [
  ...
  { id: 'table1', name: 'Devil\'s Roulette', category: GameCategory.TABLE, image: 'https://picsum.photos/seed/table1/400/600', is666: false, gameType: 'roulette', description: 'Una ruleta clásica con un giro. ¿Apostarás al rojo, al negro o al número de la bestia?', musicUrl: 'https://cdn.pixabay.com/download/audio/2022/11/22/audio_198c697a76.mp3' },
